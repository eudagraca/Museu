...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div uk-grid>
        ...
        <div class="uk-width-1-3@m uk-align-center" uk-lightbox="animation: slide">
            <a class="uk-inline" href="{{ asset('assets/images/paginas/subestacao_lamigo_1970.jpeg') }}" data-caption="Subestação de lamego Julho de 1970">
                <img style="margin-right: -19%;"src="{{ asset('assets/images/paginas/subestacao_lamigo_1970.jpeg') }}" class="uk-border-rounded"
                    width="500px" height="150px" alt="" uk-img></a>
            <p class="uk-text-primary">Subestação de lamego Julho de 1970</p>

            <a class="uk-inline" href="{{ asset('assets/images/paginas/subestacao_de_lamigo_1972.jpeg') }}" data-caption="Subestação de Lamego, Julho de 1972">
                <img style="margin-right: -19%;"src="{{ asset('assets/images/paginas/subestacao_de_lamigo_1972.jpeg') }}" class="uk-border-rounded"
                    width="500px" height="150px" alt="" uk-img></a>
            <p class="uk-text-primary">Subestação de Lamego, Julho de 1972</p>


            <a class="uk-inline" href="{{ asset('assets/images/paginas/linha_mavuzi_beira.jpeg') }}" data-caption="Construção da linha de alta tensão , Beira - Mavuzi">
                <img style="margin-right: -19%;"src="{{ asset('assets/images/paginas/linha_mavuzi_beira.jpeg') }}" class="uk-border-rounded"
                    width="500px" height="150px" alt="" uk-img></a>
            <p class="uk-text-primary">Construção da linha de alta tensão , Beira - Mavuzi</p>


            <a class="uk-inline" href="{{ asset('assets/images/paginas/linha_mavuzi_beira_2.jpeg') }}" data-caption="Construção da linha de alta tensao Beira 1 Central mavuzi-Beira, 29-09-1972">
                <img style="margin-right: -19%;"src="{{ asset('assets/images/paginas/linha_mavuzi_beira_2.jpeg') }}" class="uk-border-rounded"
                    width="500px" height="150px" alt="" uk-img></a>
            <p class="uk-text-primary">Construção da linha de alta tensao Beira 1 Central mavuzi-Beira, 29-09-1972</p>
        </div>


        <p class="uk-text uk-margin-left uk-margin-small-top  uk-margin-remove-right uk-text-justify">A adjudicatária da Linha foi a SAE Italiana, as Subestações ficaram a cargo da Cogelex da França, sendo a wed Power da Suécia consultora do Projecto.</p>

        <p class="uk-text uk-margin-left uk-margin-small-top  uk-margin-remove-right uk-text-justify">Sobre estes projectos, Ernesto Faela, topógrafo reformado, relata que:</p>

        <p class="uk-text-italic uk-text uk-margin-left uk-margin-remove-right uk-text-justify uk-margin-small-top">”Depois de ter trabalhado com os alemães na Linha de Nacala - Nampula, a partir de Maio levei quase todo o ano de 1979 naquele projecto e no ano seguinte, fui orientado para trabalhar com topógrafos Suecos, dirigidos pelo Eng. Tommy Lindh, na Zambézia em plena execução da Linha Centro-Norte. <br> Nessa altura, eles não faziam a concepção da Linha de 220 KV, pois aquela estava sendo erguida, provavelmente tivesse sido estudada anos antes pelo empreiteiro ou pelos portugueses. <br>
        ...
        <p class="uk-text uk-margin-left uk-margin-top  uk-margin-remove-right uk-text-justify">Enquanto prosseguia os trabalhos na parte norte, a EDM conseguiu financiamento dos Bancos Italianos e da ASDI para a construção da Linha para o vale do Limpopo, partindo de Infulene-Macia- Chokwe-Xai-Xai a uma tensão de 110KV, em 1982-1983, tendo sido montado em Macia um Posto de seccionamento, em meados de Agosto de 1983. Este projecto foi coordenado pelo Eng. Higino Fabião, na altura gestor de projectos na Direcção de Engenharia de Redes, sendo o Eng. Cesar Manuel seu adjunto. O Empreiteiro da Linha foi a <i>SADELMI</i> Italiana, que no fundo era a <i>SAE</i> que se fundira com uma outra empresa, resultando em <i>SADELMI</i>. </p>

        <p class="uk-text uk-margin-left uk-margin-top uk-margin-remove-right uk-text-justify">Com os Acordos Gerais de Paz, pondo fim a Guerra Civil de 16 anos em Moçambique, a cidade de Xai-Xai e Inhambane ficaram interligadas por uma linha a 110 KV, que veio a ser concluída em 2004.</p>

        <ul class="uk-list uk-list-disc uk-margin-top uk-list-primary uk-margin-remove-right uk-margin-left ">
        ...
        <p class="uk-text uk-margin-left uk-margin-top uk-margin-remove-right uk-text-justify">Com estes empreendimentos erguidos foi possível iniciar os Projectos de Electrificação de todas as Sedes Distritais que terminou em 2017, estando neste momento a ser implementados Projectos de Electrificação dos Postos Administrativos.  </p>
    </div>
