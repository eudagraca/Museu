...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="governanca">
        ...
        <p class="uk-dropcap uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">A primeira linha de
            ...
            Beira da
            Munhava. Na Beira, a SHER instalou uma Subestação eléctrica na Munhava nas imediações onde estava localizada
            a Central.
        </p>
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">A experiência de SHER de
            ...
            Transporte de
            275KV e a respectiva Subestação foi ACTA- Actividades Eléctricas Associadas SARL, a firma M. Bronze ficou
            com a
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">O outro concurso que a SONEFE
            ...
            Marca
            &quot;SAVIGLIANO&quot;. No concernente aos trabalhos de construção civil para o Posto de Seccionamento da
            Linha de Transporte em
            Ressano Garcia foi seleccionada a Kruger Moçambique, que uma vez apurada foi posta a esperar por uns meses,
            apenas em
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">Os testes na Subestação de
            ...
            remeter os
            275KV, a corrente variava entre 300 a 320KV, não obstante aos finais de semana, sobretudo a noite a ESKOM
            tinha
            dificuldades de carga. Apesar disso ficou claro que com efeitos a 25 de Novembro de 1972 a ESKOM passou a
            fornecer
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">Com a Independência Nacional e a
            ...
            aliado a isso
            tinha o Sr. Oliveira, Selemane Jafar, o Encarregado Ali Mansur dentre outros. Com a saída do Eng. Cabrita e
            Rodrigues a
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">Até a independência Nacional de
            ...
            1975 acabava
            de ser concluída a construção da Central Hidroeléctrica de Cahora Bassa e dois anos depois foi criada, facto
            que lhe
            permitiu desencadear uma campanha acesa para angariação de fundos para aproveitar o recurso hídrico daquela
            central e
        ...
        <div class="uk-margin-large-left uk-margin-large-right">
            <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">Adjudicatária da Linha foi a SAE
                ...
                Suécia
                era consultora do Projecto.
            </p>
            <p class="uk-text uk-margin-small-left uk-margin-right uk-text-justify">Por Sobre estes projectos, Ernesto
                Faela, topografo reformado, relata que:
            </p>
            <p class="uk-text uk-text-italic uk-margin-left uk-margin-right uk-text-justify">&quot;que depois de ter
                trabalhado com os alemães na Linha de Nacala - Nampula, a partir de Maio levou quase todo o ano de
                1979 naquele projecto e no ano seguinte, foi orientado para trabalhar com topógrafos Suecos, dirigidos
                pelo Eng. Tommy
                Lindh, na Zambézia em plena execução da Linha Centro-Norte.
            </p>
            <p class="uk-text uk-text-italic uk-margin-left uk-margin-right uk-text-justify">Nessa altura, eles não
                faziam a concepção da Linha de 220 KV, pois aquela estava sendo erguida, provavelmente tivesse
                sido estudada anos antes pelo empreiteiro ou pelos portugueses
            </p>
            <p class="uk-text uk-text-italic uk-margin-left uk-margin-right uk-text-justify">Na Zambézia estiveram
                inicialmente em Chimuara onde concebiam as futuras Linhas de 110KV, que seriam derivadas daquelas
                Subestações para os diferentes pontos ao nível da jurisdição daquelas S.E.
            </p>
            <p class="uk-text uk-text-italic uk-margin-left uk-margin-right uk-text-justify">Quando terminaram, ainda em
                1980, seguiram para o Levantamento de Nampula-Ocua (na outra margem do rio Lurio) que era o
                local onde se esperava que seria montada a Subestação para alimentar aquela região e depois a Linha
                prosseguiria a
                Pemba.&quot;
            </p>
        </div>
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">Enquanto prosseguia os trabalhos na parte
            ...
            em
            1982-1983, tendo sido montado em Macia, um Posto de seccionamento, em meados de Agosto de 1983. Este
            projecto foi
            encarregue o Eng. Higino Fabião, na altura gestor de projectos na Direcção de Engenharia de Redes, sendo
            Eng. Cesar
            Manuel seu adjunto. O Empreiteiro da Linha foi a <i>SADELMI</i> Italiana, que no fundo era a <i>SAE</i> que
