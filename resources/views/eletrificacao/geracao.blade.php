...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div uk-grid>
        ...
        <div class="uk-width-1-1@m uk-margin-remove">
            ...
            <p class="uk-dropcap uk-text uk-margin-left uk-margin-small-top  uk-text-justify">As primeiras iniciativas visando estabelecer a iluminação pública nas principais povoações da costa moçambicana datam da segunda metade do século XIX, através de candeeiros abastecidos a petróleo. 
            </p>
            ...
            <div class="uk-margin-right">
                <div class="uk-text-center" uk-grid>
                    ...
                    <p class="uk-text uk-margin-left uk-margin-small-top  uk-text-justify">A Central Térmica de Lourenço Marques, que depois da Independência ficou conhecida por Central Térmica de Maputo (CTM) tinha como base de funcionamento o Carvão que era trazido pelos comboios a partir da Republica da África do Sul e o Gás que na prática era o combustível de avião. Porém, grande parte da maquinaria nos meados da década 80 não rendia integralmente; as máquinas de 6,25MW apenas produziam 5MW enquanto as de 15MW conseguiam produzir até aos 12MW, devido ao desgaste com o tempo, facto que obrigou o redesenhar das estratégias a seguir. Uma das estratégias foi abandonar a tecnologia da geração baseada no carvão e adoptar a de produção a gás dada a descoberta de Gás em Temane e Pande, em Inhambane. 
                    </p>
