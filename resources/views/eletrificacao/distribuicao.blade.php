...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div uk-grid>
        ...
        <div class="uk-width-expand@m uk-width-1-1@m uk-margin-remove">
            ...
            <p class="uk-dropcap uk-text uk-margin-left uk-margin-right uk-text-justify">A Distribuição de energia andou
                estreita com a Geração de corrente eléctrica. Em Maputo, na época da Delagoa Bay, nos
                anos de 1903 a 1946 e subsequentemente com os S.M.A.E, de 1947-1963, a distribuição era feita a partir
                de circuitos que
            ...
            <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">Eram utilizados para distribuição Linhas
                Aéreas, com recurso aos postes de aço, copos de porcelana fixos por ferragens e
                condutores de cobre. Aquela tecnologia permaneceu em Lourenço Marques até altura que entrou em voga a
                Nova Rede de
            ...
            <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">Para alcançar os objectivos foi antecedido
                por um levantamento exaustivo em 1956 da potência das instalações onde haviam
                participado Electricistas de várias instituições a cargo do SMAE, a destacar: CFM, Câmara Municipal,
                Hotel Polana,
                Companhia Industrial da Matola dentre outras. Com aqueles resultados foi possível prever as potências
                dos
            ...
            <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">O S.M.AE, sabendo das fontes oficiais da
                época, que uma nova Central Térmica estava sendo erguida e sendo
                concessionários da distribuição, procedeu um estudo das necessidades para a montagem de uma Nova Rede e
                logo a seguir
        ...
        <p class="uk-text uk-margin-left uk-margin-small-topuk-margin-right uk-text-justify uk-margin-small-top">O  primeiro ano das obras foi
            ...
            postes, circuitos que
            haviam servido de interface para alimentar os consumidores ao longo do tempo, de tal modo que a
            cidade
            alcançou o
            estatuto das cidades modernas em que os condutores ficam embutidos via subterrânea.</p>

        <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">No entanto, a Rede Aérea permaneceu
            nos
            bairros suburbanos de Lourenço Marques, inclusive foram desenhados projectos de
            Melhoramento do Caniço, onde foram construídas algumas Linhas nos Bairros de Aeroporto, Xipamanine,
            Maxaquene e Sofil
            (Luis Cabral). A concepção do plano geral de electrificação destes Bairros foi do Eng. Fernando
            Faria
            Lopes e os
            técnicos da execução foram, Eduardo Sebastião Paixão Correia., J. Corte Real e F. Moura que no final
            da
            execução do
            Projecto os SMAE decidiram distribuir a verba restante aquela equipa, com excepção do Eng Fernando
            Faria
            Lopes que
            recusou, com valores que variavam entre 40.000 escudos a 10.000$00, em 1972. (Acta 45/72, de 10 de
            Novembro).</p>

        <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">Com a EDM, os condutores de cobre nu
            que
            abundavam nos bairros passaram a ser substituídos pelo cabo torçado e uso de
            ligadores ao invés dos copos, facto que alterou positivamente a operação das redes de distribuição.
        </p>

        <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">A distribuição evoluiu drasticamente
            com o
            maior acesso dos materiais, disponibilização de muitos PTs numa dada zona e
            maior proximidade conduzem para redução de perdas, contrariamente ao que acontecia no passado onde
            uma
            vila dispunha de
            um ou dois PTs com 3.000 clientes ou mais. Na prática, foi o culminar de esforços conjugados em que
            o
            Transporte trouxe
            para muito perto as subestações e consequentemente, as linhas de distribuição não precisam percorrer
            muitos quilómetros
            da fonte ao PT que alimenta os consumidores..</p>

        <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">Cidades como Beira, Nampula seguiram
            em
            alguns troços o padrão da rede de distribuição subterrânea enquanto as cidades
            com uma dimensão inferior como Pemba, Lichinga e outras, a rede está acessível ao olhar de qualquer
            um,
            como resultado
            das heranças das antigas concessionárias.</p>
