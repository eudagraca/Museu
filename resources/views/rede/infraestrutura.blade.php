    ...
    <div uk-grid>
        ...
        <div uk-grid class="uk-margin-remove">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-width-1-2@m uk-align-center" uk-lightbox="animation: slide">
                        <a class="uk-inline uk-margin-right uk-margin-top"
                            ...
                            <img src="{{ asset('assets/images/elementos_da_rede.png') }}" class="uk-border-rounded" width="350px"
            ...
            <div class="uk-width-1-4@m" uk-lightbox="animation: slide">
                <a class="uk-inline uk-margin-right uk-margin-top"
                    href="{{ asset('assets/images/paginas/linha_66kv.jpg') }}"
                    data-caption="Linha de 66kV">
                    <img src="{{ asset('assets/images/paginas/linha_66kv.jpg') }}" class="uk-border-rounded"
