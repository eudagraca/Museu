...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="governanca">
        ...
        <h4 class="uk-heading-bullet uk-text-bolder uk-text-primary uk-margin-left">Serviços</h4>
        <h5 class="uk-margin-left uk-text-bold uk-margin-large-right uk-text-justify">
        ...
        <ul class="uk-text uk-margin-left uk-text-justify">
            ...
            <li>Central de Atendimento (1455); </li>
            <li>Portal do Cliente: <a href="https://cliente.edm.co.mz" class="uk-button uk-button-text uk-text-lowercase uk-text-primary uk-text-bold">https://cliente.edm.co.mz;</a></li>
