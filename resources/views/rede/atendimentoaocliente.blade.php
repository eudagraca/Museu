...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="governanca">
        ...
        <h4 class="uk-heading-bullet uk-text-bolder uk-text-primary uk-margin-large-left">Formas de Atendimento ao Cliente</h4>
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-top uk-margin-large-right uk-text-justify">
            ...
            <ul class="uk-margin-large-left uk-text uk-text-justify"><li>Para a participação de avarias de natureza eléctrica, reclamações, sugestões, ou informações diversas, a EDM dispõe de
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            ...
            <ul class="uk-margin-large-left uk-text uk-text-justify"><li>Em caso de insatisfação, perante a resposta obtida em primeira instância, ou simplesmente devido à inacção ou silêncio
        ...
        <div class="uk-width-1-2@m uk-align-center" uk-lightbox="animation: slide">
            <a class="uk-inline" href="{{ asset('assets/images/infraestrutura_cliente.png') }}"
                data-caption="Fonte: Plano de Negócio da EDM 2020 - 2024">
                <img src="{{ asset('assets/images/infraestrutura_cliente.png') }}" class="uk-border-rounded" width="750px"
                    height="133px" alt="" uk-img></a>
        </div>
        <i class="uk-text-small uk-text-danger uk-margin-large-left uk-margin-large-right uk-text-justify">
        ...
        <div class="uk-width-1-2@s uk-width-2-5@m uk-margin-large-left">
            <ul class="uk-nav uk-nav-default uk-align-left">
                ...
                <li class="uk-flex uk-flex-left"><a class="uk-button uk-button-text" href="{{ route('rede.show', "comercial") }}">Comercial</a></li>
