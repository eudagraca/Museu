        ...
        <div uk-grid class="uk-margin-remove">
            <div class="uk-width-expand@m uk-width-1-1@m uk-padding-remove-left">
                ...
                <p class="uk-dropcap uk-text uk-margin-left uk-margin-right uk-text-justify">
                    ...
                    clientes, por via da comunicação e divulgação, e disponibilização dos produtos e serviços da empresa
                    aos segmentos de
                ...
                <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">
                    A função comercial é coordenada centralmente pela Direcção Geral Comercial, cuja missão é executar a
                    visão estratégica
                    da empresa e promover a adopção de políticas comerciais, normas e processos que garantam o alcance
                    de resultados com
                    máxima eficácia e eficiência. Para tal, conta com duas Direcções Centrais dedicadas à gestão dos
                    segmentos de clientes
                    de Grande e Baixo Consumo e integra um Departamento de Marketing e Vendas, através dos quais
                    assegura a implementação e
                    melhoria contínua das políticas e dos processos comerciais.
                </p>
                <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">
                    Sendo que a função comercial da EDM é de cobertura nacional, foi necessário atribuir às Delegações,
                    as competências
                    operacionais de contratação de novos clientes, a gestão da base de clientes, no que respeita ao
                    ciclo de facturação,
