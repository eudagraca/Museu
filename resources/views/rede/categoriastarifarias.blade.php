...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="governanca">
        ...
        <h4 class="uk-heading-bullet uk-text-bolder uk-text-primary uk-margin-left">Categorias Tarifárias </h4>
        ...
        <div class="uk-width-1-2@m uk-align-center" uk-lightbox="animation: slide">
            <a class="uk-inline" href="{{ secure_asset('assets/images/categorias_tarifarias.png') }}"
                ...
                <img src="{{ secure_asset('assets/images/categorias_tarifarias.png') }}" class="uk-border-rounded" width="750px"
