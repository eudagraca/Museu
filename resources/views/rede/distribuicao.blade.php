...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="governanca">
        ...
        <p class="uk-dropcap uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            ...
            responsabilidade é de definir políticas e harmonizar os procedimentos de instalação, operação, manutenção, automação e
            gestão de uma maneira uniforme dos activos do segmento Distribuição da EDM, que compreende os seguintes níveis de
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            A infra-estrutura de distribuição é composta por Mini-subestações, linhas aéreas, linhas subterrâneas, postos de
            transformação, armários e quadros de distribuição.
        </p>
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            A Direcção de Distribuição tutela 5 Direcções Regionais, nomeadamente: Norte, Centro, Sul, Cidade de Maputo e Província
            de Maputo e 23 Delegações.
        </p>
        <i class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
        ...
        <div class="uk-width-1-5@m uk-align-center" uk-lightbox="animation: slide">
            <a class="uk-inline" href="{{ asset('assets/images/provincias_delegacoes.png') }}"
                ...
                <img src="{{ asset('assets/images/provincias_delegacoes.png') }}" class="uk-border-rounded" width="250px"
        ...
        <div class="uk-width-expand@m uk-align-center">
            <table class="uk-table uk-table-striped ">
                ...
                <tbody>
                    ...
                    <tr><td colspan="7" class="uk-text-center">Racios de densificação da Rede de Distribuição</td></tr>
                    <tr>
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            O facto de a maior parte da população moçambicana residir nas zonas rurais é evidenciado pelos rácios de densificação
            que constam da tabela acima.
        </p>
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            Com a excepção da Região da Cidade de Maputo, outras regiões têm uma média de 80 clientes por quilómetro de rede de
            distribuição em baixa tensão e menos de 1 (um) posto de transformação por quilómetro de rede de média tensão. Assim,
            para a universalização do acesso de energia à população, a EDM irá apostar, não só na expansão da rede para novos
            centros de consumos, mas também na densificação, que consiste em maximizar a exploração das infra-estruturas existentes.
        </p>
    </div>
</div>
@endsection
