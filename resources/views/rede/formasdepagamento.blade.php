...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="governanca">
        ...
        <h4 class="uk-heading-bullet uk-text-bolder uk-text-primary uk-margin-large-left">Formas de Pagamento de Facturas.</h4>
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-top uk-margin-large-right uk-text-justify">
            ...
            <ul class="uk-margin-large-left uk-text uk-text-justify"><li>Pode pagar a sua conta de energia com toda a comodidade e conforto através dos cartões electrónicos da rede VISA, nas
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            ...
            <ul class="uk-margin-large-left uk-text uk-text-justify"><li>É um meio de pagamento automático da sua factura através do seu Banco. É flexível e confiável. Para aderir a este
        ...
        <p class="uk-text uk-margin-large-left uk-margin-large-right uk-text-justify">
            ...
            <ul class="uk-margin-large-left uk-text uk-text-justify"><li>Para a compra de energia pré-paga (Credelec), o cliente deverá ter consigo o número do contador pré-pago e
            ...
            <li>Canais disponíveis para a venda de energia:
                <ul class"uk-margin-left">
                    <li>Postos de venda da EDM e Privados; n ATM's (Millennium BIM e Rede Ponto 24);</li>
