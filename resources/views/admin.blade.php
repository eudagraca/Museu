        ...
        <div id="sidebar" class="tm-sidebar-left uk-background-default">
            ...
            <ul class="uk-nav uk-nav-default">
                ...
                <li class="uk-nav-header">
                    <a href="{{ route('home') }}">Museu</a>
                </li>
                <li class="uk-nav-header">
                    Linha do tempo
                </li>
                <li><a href="{{ route('linhaTempo.index') }}">Lista</a></li>
                <li><a href="{{ route('linhaTempo.create') }}">Adicionar</a></li>

                <li class="uk-nav-header">
                    Galeria
                </li>
                <li><a href="{{ route('galeria.indexMain') }}">Lista de imagens</a></li>
