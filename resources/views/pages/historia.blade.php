            ...
            <nav class="uk-navbar uk-background-primary" uk-navbar style="position: relative; z-index: 980;">
                ...
                <div class="uk-navbar-right">
                    <ul class="uk-navbar-nav">
                        <li class="uk-active uk-button-text"><a href="#" uk-scroll>Linha de tempo</a></li>
                        <li class="uk-active uk-button-text"><a href="#equipe" uk-scroll> Personalidades</a></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="uk-container uk-margin-large-bottom">
        <div uk-grid>
            <div class="uk-width-expand@m">
                <h2 class="uk-heading-bullet uk-margin-large-right uk-text-bold uk-text-primary uk-margin-small-bottom">Linha de tempo</h2>
                            ...
                            <div class="uk-width-1-3@m" uk-lightbox="animation: slide">
                                <div class="uk-margin-small-bottom">
                                    <a class="uk-inline uk-border-rounded uk-text-bold uk-flex uk-flex-center"
                                        href="{{ asset('assets/images/logo-edm.png') }}"
                                        data-caption="Provincia de Manica - Barragem da Chicamba.">
                                        <img src="{{ asset('assets/images/logo-edm.png') }}" alt="">
                                    </a>
                                </div>
                    ...
                    <li class="uk-grid">
                        <div class="uk-child-width-1-3@m" uk-grid uk-lightbox="animation: slide">
                            <div class="uk-width-1-3@m" uk-lightbox="animation: slide">
                                <div class="uk-margin-small-bottom">
                                    <a class="uk-inline uk-border-rounded uk-text-bold uk-flex uk-flex-center"
                                        href="{{ asset('assets/images/ponte_iluminada.jpg') }}"
                                        data-caption="Provincia de Manica - Barragem da Chicamba.">
