    ...
    <div uk-grid>
        <div class="uk-width-1-2@s">
            ...
            <form class="uk-form-stacked ">
                ...
                <div>
                    ...
                    <p class="uk-text-lighter uk-margin-remove-bottom"><span class="uk-text-danger">(*)</span> Campos
                        obrigatórios</p>
        ...
        <div class="uk-width-1-2@s uk-margin-top">
            ...
            <p class="uk-text uk-text-justify">
                Caro visitante, pode entrar em contacto connosco apartir do formulário ao lado. Teremos imenso prazer em
