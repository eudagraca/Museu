...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="organica">
        ...
        <div class="uk-width-1-2@m uk-align-center" uk-lightbox="animation: slide">
            <a class="uk-inline" href="{{ asset('assets/images/estrutura_organizacional.png') }}" data-caption="Estrutura Organizacional de Alto Nível">
            <img src="{{ asset('assets/images/estrutura_organizacional.png') }}" class="uk-border-rounded"
