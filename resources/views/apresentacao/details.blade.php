...
<div class="uk-flex ukflex-center uk-align-right">

 <a class="uk-button uk-button-primary" href="#apresentacao">Apresentação da EDM</a>
 <a class="uk-button uk-button-primary" href="#governanca">Modelo de governança</a>
 <a class="uk-button uk-button-primary" href="#organizacao">Estrutura Organizacional</a>
</div>
    <div class="uk-width-1-1@m" id="apresentacao">
        ...
        <div class="uk-margin-left uk-margin-right">
            ...
            <ul class="uk-list uk-list-disc uk-list-primary uk-margin-right uk-margin-left">
                <li class="uk-text-black">Estabelecimento e exploração dos meios de produção próprios e dos que fazem parte do património do Estado colocado à
                ...
                fora dele;</li>
                <li class="uk-text-black">Gestão e operação da rede nacional de transporte de energia eléctrica, na qualidade de Gestor de Rede Nacional de
                Transporte (RNT) e</li>
