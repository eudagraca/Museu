...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top">
    ...
    <div class="uk-width-1-1@m" id="apresentacao">
        ...
        <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">Em Outubro de 1997, acompanhando as tendências
            ...
            quadro nacional
            e aprova a regulamentação específica que estabelece a Política Energética (resolução 05/98 de 3 de Março),
            que confere à
        ...
        <div class="uk-margin-left uk-margin-right">
            ...
            <ul class="uk-list uk-list-disc uk-list-primary uk-margin-right uk-margin-left">
                <li class="uk-text-black">Estabelecimento e exploração dos meios de produção próprios e dos que fazem
    ...
    <div class="uk-width-1-1@m">
        ...
        <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">
            Produzir, transportar, distribuir e comercializar energia eléctrica de boa qualidade, de forma sustentável,
            para
    ...
    <div class="uk-width-1-1@m">
        ...
        <p class="uk-text uk-margin-left uk-margin-right uk-text-justify">
            Transformar a EDM numa Utilidade Inteligente e Sustentável, que dá acesso à energia eléctrica de qualidade a
            cada
        ...
        <div class="uk-width-1-2@m uk-align-center" uk-lightbox="animation: slide">
            <a class="uk-inline" href="{{ secure_asset('assets/images/estrutura_organizacional.png') }}"
                ...
                <img src="{{ secure_asset('assets/images/estrutura_organizacional.png') }}" class="uk-border-rounded"
                    width="850px" height="533px" alt="" uk-img></a>
        </div>
    </div>
</div>
@endsection
