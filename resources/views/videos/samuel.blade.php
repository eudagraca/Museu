...
<body>
    ...
    <div class="uk-section uk-section-primary uk-margin-large-bottom">
        ...
        <p class="uk-margin-large-left uk-text-white">Acompanhe de perto a história de vida de Samuel Checo, funcionário da EDM</p>
        </div>
    </div>
    ...
    <div class="uk-container uk-margin-large-bottom">
        ...
        <video class="uk-width-3-4 uk-align-center uk-box-shadow-hover-medium" src="../public/assets/videos/samuel_checo.mp4"  controls playsinline uk-vide></video>
    </div>
