...
<body>
    ...
    <div class="uk-section uk-section-primary uk-margin-large-bottom">
        ...
        <h2 class="uk-heading-bullet uk-text-bolder uk-margin-large-left uk-text-primary">João Cumbe</h2>
        <p class="uk-margin-large-left uk-text-white">Acompanhe de perto a história de vida de João Cumbe, funcionário da EDM</p>
        </div>
    </div>
    ...
    <div class="uk-container uk-margin-large-bottom">
        ...
        <video class="uk-width-3-4 uk-align-center uk-box-shadow-hover-medium" src="../public/assets/videos/joao_cumbe.mp4"  controls playsinline uk-vide></video>
    </div>
