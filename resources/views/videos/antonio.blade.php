...
<head>
    ...
    <script src="../public/js/uikit.js" type="text/javascript"></script>
    <script src="../public/js/uikit-icons.min.js" type="text/javascript"></script>
    <title>Video - Antonio</title>
</head>
...
<body>
    <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; bottom: #transparent-sticky-navbar">
        ...
        <nav class="uk-navbar-container" uk-navbar style="position: relative; z-index: 980;">
            <div class="uk-navbar-left">
                <a class="uk-navbar-item uk-logo" href="../index.html"><img src="../public/assets/images/logo-edm.png" alt="" srcset=""></a>
            </div>
            <div class="uk-navbar-right">
                <ul class="uk-navbar-nav">
                    <li class="uk-active uk-button-text"><a href="../linha_do_tempo.html">Linha do tempo</a></li>
                    <li class="uk-active">
    ...
    <div class="uk-section uk-section-primary uk-margin-large-bottom">
        ...
        <h2 class="uk-heading-bullet uk-text-bolder uk-margin-large-left uk-text-primary">António Chamusso</h2>
        <p class="uk-margin-large-left uk-text-white">Acompanhe de perto historias de vida de António Chamusso, funcionário da EDM</p>
        </div>
    </div>
    ...
    <div class="uk-container uk-margin-large-bottom">
        ...
        <video class="uk-width-3-4 uk-align-center uk-box-shadow-hover-medium" src="../public/assets/videos/antonio_chamusso.mp4"  controls playsinline uk-vide></video>
    </div>
