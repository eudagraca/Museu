...
<div class="uk-container uk-margin-large-bottom uk-margin-large-top uk-margin-small-right">
            ...
            <div uk-grid="masonry: true" uk-lightbox="animation: slide">
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Ano de entrada em serviço</span>: Tempo colonial e requalificada
                            em
                            2003/2004
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Ano de entrada em serviço</span>: Tempo colonial, requalificada
                            em
                            2003/2004
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: O TR1 [33/11kV - 25MVA] encontrasse avariado e fora
                            de
                            serviço
                        </p>
                    </div>
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Localizacação</span>: Cidade de Maputo, Kaphumo, Bairro de
                            Mavalane
                            -Aeroporto.
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: Recebe tensão em 66kV a partir da SE Infulene,
                            através
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Localizacação</span>: Cidade de Maputo, kapfumo, Bairro do
                            Zimpeto
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: Recebe da linha DL14 a partir da Subestação de
                            Matola.
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: A Subestação de Boane recebe a partir da Subestação
                            de
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Localizacação</span>: Província de Maputo, no distrito de Boane,
                            no
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Transformadores de potência</span>: TR1 [275/66/11kV - 250MVA],
                            TR2
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Transformadores de potência</span>: TR1 [275/66/33kV - 160MVA],
                            TR2
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Localizacação</span>: Província de Maputo, no distrito de
                            Manhiça.
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: Recebe alimentação a 66KV a partir da SE Matola
                            275KV
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: A subestação recebe a tensão a partir da subestação
                            de
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: A subestação recebe a tensão a partir de duas
                            fontes,
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Localizacação</span>: Provincia de Gaza, no distrito de Xai –
                            Xai,
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <span class="uk-text-bold">Localizacação</span>: Provincia de Inhambane, Distrito de
                            Jangamo,
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top">
                            <span class="uk-text-bold">Nota</span>: Recebe 110kv a partir de SE Lionde através das
                            linhas
                            CL10.
                        </p>
                    </div>
    ...
    <hr class="uk-margin-large-top" style="margin-top: 350px !important">
