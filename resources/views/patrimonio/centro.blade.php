        ...
        <div class="uk-width-1-1@m uk-margin-remove-top uk-margin-remove-right">
            ...
            <div uk-grid="masonry: true" uk-lightbox="animation: slide">
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Transformadores de potência</spa>: TR1 [22MVA – 66/33kV]; TR2 [10MVA – 33/11kV]; TR3 [10MVA – 33/11kV];
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 20.18MW correspondente a 22.42MVA/ Março de 2020
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: TR1 em Sobrecarga, celas de 11kV obsoletas, 3 celas de 33kV avariadas
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: A Subestação pertencia a antiga Área Operacional de Tete, actualmente Área do Serviço Cliente de Tete. Apos uma
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 18.89MW correspondente a 20.99MVA/ Novembro de 2020
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Vila de Manje, Distrito de Chiúta, Província de Tete
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 4.15MW correspondente a 4.61MVA/ Novembro de 2020
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Sem celas de Reserva de 33kV, dado aos Plugs especiais diferentes das usadas em outras SE’s
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: As obras da Subestação de Manje foram financiadas pelo Governo de Moçambique em 2007, entrando em serviço no dia 24 de
                            Dezembro de 2008.
                        </p>
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Sabão, vila de Catandica, Distrito de Bárue, Província de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: A quando da sua entrada em serviço funcionou com um Transformador (25MVA) vindo da SE Cerâmica na Zambézia, tendo a
                            Subestação se beneficiado a posterior de uma reabilitação que terminou em 2010, passando a funcionar com o actual TR de
                            10MVA.
                        </p>
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro de Chibata, Localidade Chiremera, Distrito de Vanduzi, Provincia de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Transformadores de potência</spa>: TR1 [84/72/57MVA - 220/110/18.6kV]; TR2 [84/72/57MVA - 220/110/18.6kV]
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: A Subestação foi inaugurada oficialmente no dia 10/03/2004, operando com um TR de 84MVA até 2015, pois no dia 25 de
                            Abril de 2015 entrou em serviço o TR2 em paralelo, perfazendo uma capacidade total Instalada da Subestação de 168MVA.
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Josina Machel, Distrito de Manica, Província de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: A Subestação de Manica beneficiou-se de uma total mudança, tendo sido construída uma nova de raiz ao lado da antiga, que
                            entrou em serviço no dia 19 Julho de 2020 em vazio, e no dia 16 de Agosto de 2020 foram transferidas todas as cargas da
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro 25 de Setembro, Posto Administrativo de Messica, Distrito de Manica, Província de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Transformadores de potência</spa>: TR1 [12.5/6.5/6.5MVA – 110/22/6.6kV]
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 1.76MW correspondente a 1.96MVA/ Outubro de 2020
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Bom, operando normalmente apesar do transformador ser muito antigo (fabricado 1963), e tem o enrolamento de 22kV
                            indisponível
                        </p>
                    </div>
                </div>
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">Subestação de Messica</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro 3, Posto administrativo de Mavita, Distrito de Sussundenga, Provincia de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 2.91MW correspondente a 3.23MVA/ Novembro de 2020
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro 7 de Abril, Cidade de Chimoio, Província de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Transformadores de potência</spa>: TR1 [6MVA – 66/6.6kV]; TR4 [6MVA – 66/6.6kV]; TR3 [4MVA – 22/6.6kV]
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 23.5MW correspondente a 25.71MVA/ Novembro 2019
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Os TRs são muito antigos, fugas de óleo nos TRs 3 e 4, falta de disjuntos de reserva.
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: O barramento de 22kV da Subestação de Chimoio1 é alimentado a partir de uma linha (em 22kV) que sai da Subestação de
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Francisco Manyanga, Cidade de Chimoio, Província de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Transformadores de potência</spa>: TR2 [25/25/6MVA – 110/66/22kV]; TR3 [20MVA – 110/22kV]
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 24MW correspondente a 26.67MVA/ Novembro de 2019
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Inoperância do enrolamento de 22kV do TR2 e falta de disjuntores em algumas celas de 22kV.
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: A subestação beneficiou-se de 2 reabilitações, sendo a primeira concluída em 2011, e a segunda com vista a
                            operacionalização de IN & OUT da linha CL75 (que parte de Chibata a Dondo) que antes fazia o T- OFF na Subestação de
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Nhachoco, Distrito de Gondola, Província de Manica
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Nota</spa>: A Subestação já atingiu 9.9MW num caso excepcional em que foram alimentadas algumas cargas da SE Chimoio devido a uma
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Mozalec, Posto Administrativo de Inchope, Distrito de Gondola, Provincia de Manica
                        </p>
                        <p class="uk-margin-small">
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Posto Administrativo de Casa Nova, Distrito de Muxungue, Província de Sofala
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 2.31MW correspondente a 2.57MVA/ Dezembro de 2020
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Bom, operando normalmente
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: A Subestação Móvel Casa Nova foi instalada para o restabelecimento de energia eléctrica aos Distritos de Chibabava na
                            Província de Sofala, Machaze, Mussorizi e Posto Administrativo de Dombe na Província de Manica, logo após a passagem do
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: 2º Bairro, Localidade de Lamego, Distrito de Nhamatanda, Província de Sofala
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Avaria das celas do barramento e das linhas de 22kV, estando a operar provisoriamente com Bay Exterior desde o dia 07 de
                            Dezembro de 2020.
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: A Subestação beneficiou-se de uma total reabilitação que foi concluído em 2017, transitando de sistema T-OFF para IN &
                            OUT, e elevando a sua capacidade de 18.8 para 25MVA através de instalação de um novo Transformador.
                        </p>
                    </div>
                </div>
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Luís Inácio, Localidade de Guara Guara, Distrito de Buzi, Província de Sofala
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Ponta/Data</spa>: 2.2MW correspondente a 2.44MVA/ Fevereiro de 2019
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Bom, operando normalmente
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: A quando da sua entrada em serviço operou com um Transformador de 6.3MVA – 66/33kV, tendo de seguido se beneficiado de
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Munhonha, Vila de Mafambisse, Distrito de Dondo Província de Sofala
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: A Subestação de Mafambisse beneficiou-se de uma reabilitação total e a conclusão foi em 2017, passando de 12.5 para
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro da Munhava, Cidade da Baira, Provincia de Sofala
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Transformadores de potência</spa>: TR1 [30/22.5/10.5 - 110/22/6.6]; TR2 [30/22.5/10.5 - 110/22/6.6]; TR3 [30MVA – 110/22kV]
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: A Subestação beneficiou-se uma reabilitação parcial (equipamentos de 110kV) cuja conclusão foi em 2013. Para efeito de
                            compensação foram instalados nesta Subestação 5 bancos de condensadores (2 de 22kV e 1 de 6.6kV) perfazendo um total de
                            22.5MVAr, porém, 1 banco de 5MVAr-22kV foi transferido para PS da Manga e 1 de 7.5MVAr-22kV encontra-se avariado,
                            estando disponíveis 3 bancos (2 de 6.6kV com 2.5MVAr cada e 1 de 22kV – 5MVAr) com 15MVAr no total.
                ...
                <div class="uk-card uk-card-default uk-grid-collapse uk-width-1-3@s uk-margin-remove-top uk-padding-remove">
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        ...
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Bairro Nhamayabue, Distrito do Dondo, Província de Sofala
                        </p>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Ano de entrada em serviço</spa>: 1972
                        </p>
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Transformadores de potência</spa>: TR1 [100MVA - 220/110kV]; TR2 [30MVA - 110/22]; TR3 [20MVA – 110/22kV]
                        </p>
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: A subestação de Dondo beneficiou-se de uma reabilitação total, em 2016 foi concluída a parte de 110 e 22KV, em 2017 concluída a parte de 220kV que com a entrada da linha B10 no mesmo ano passou dos 20 para 100MVA da sua capacidade instalada.
                            Nesta Subestação está instalado para efeito de compensação um Reactor de 15MVAr – 220kV, e um banco de condensadores de 4.8MVAr – 22kV
            ...
            <div uk-grid="masonry: true" uk-lightbox="animation: slide">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA CL71 [CENTRAL MAVUZI- BEIRA]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Degradada, torres com emendas e cabo obsoleto devido a idade da linha
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA CL73 [CENTRAL MAVUZI-CENTRAL DE CHICAMBA]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA CL75 A [XIGODOLA- S/E CHIBATA – PS NHAMATANDA]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA CL75 BC [PS NHAMATANDA – S/E DONDO – S/E MUNHAVA BEIRA]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA CL76 [CENTRAL DE CHICAMBA - MACHIPANDA]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA CL77 [CENTRAL MAVUZI - CASA NOVA]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Bom, operando normalmente (Com duas torres tombadas devido o Ciclone IDAI)
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA DL1 [S/E CHIMOIO 1 - S/E CHIMOIO 2]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA DL2 [S/E LAMEGO – S/E GUARAGUARA]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
                        ...
                        <p class="uk-margin-small-top uk-margin-small-bottom">
                            <spa class="uk-text-bold">Estado actual</spa>: Aceitavel, operando normalmente (Com apodrecimento de postes constantes por passar na zona pantanosa)
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="uk-card-body  uk-width-1-1@m uk-padding">
                        <h4 class="uk-text-bold uk-text-primary uk-margin-remove">LINHA DL3 [S/E MATAMBO – S/E TETE]</h4>
                        <p class="uk-margin-small">
                            <spa class="uk-text-bold">Localizacação</spa>: Região Centro
                        </p>
                        <p class="uk-margin-small">
