                                                ...
                                                <ul class="uk-nav-sub">
                                                    ...
                                                    <li class="uk-parent uk-active">
                                                        <a href="{{ route('rede.show', "transporte") }}"
                                                            class="uk-active">2. Transporte</a>
                                ...
                                <li class="uk-active uk-button-text uk-text-uppercase"><a
                                    ...
                                    <div class="uk-navbar-dropdown uk-margin-remove-top">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                                            ...
                                            <li class="uk-active"><a
                                                    href="{{ route('eletrificacao.transporte') }}">História de
                                                    transporte</a></li>
                                            <li class="uk-active"><a
            ...
            <div id="sidenav" uk-offcanvas="flip: true" class="uk-offcanvas">
                <div class="uk-offcanvas-bar">
                    <ul class="uk-nav-default uk-nav-parent-icon" uk-nav="multiple: true">
                        ...
                        <li class="uk-parent">
                            <a href="#" class="uk-text-uppercase">Apresentação da EDM</a>
                            <ul class="uk-nav-sub">
                                <li class="uk-active uk-text-normal uk-text-uppercase uk-parent"><a
                                        href="{{ route('apresentacao') }}">Apresentação da EDM</a>
                                </li>
