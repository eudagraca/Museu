    ...
    <body>
        <div id="app">
            <main data-uk-height-viewport="expand: true">
                                ...
                                <ul class="uk-nav uk-navbar-dropdown-nav">
                                    ...
                                    <li class="uk-parent uk-active">
                                        ...
                                        <ul class="uk-nav-sub">
                                            ...
                                            <li class="uk-active"><a href="{{ route('rede.show', "distribuicao") }}">3.
                                                    Distribuição</a></li>
                                            <li class="uk-parent uk-active">
                ...
                <li class="uk-active uk-button-text uk-text-uppercase"><a href="{{ route('historia.index') }}">História
                        de
                ...
                <li class="uk-active uk-button-text uk-text-uppercase"><a href="{{ route('historia.user') }}">Histórias
                        de
                        Vida</a></li>
